...
class Train
  ...
  def add_wagon(wagon)
    self.add_wagon!(wagon) if (@speed == 0) && (wagon.type == self.type) #  К пассажирскому поезду можно прицепить только пассажирские, к грузовому - грузовые. И только если поезд стоит
  end
